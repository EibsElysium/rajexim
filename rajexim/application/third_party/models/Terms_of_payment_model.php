...
class Terms_of_payment_model extends CI_Model 
{
  ...
  {
    $result = $this->db->query("CALL create_top('".$data['top_name']."','".$data['top_text']."','".$data['top_type']."','".$data['created_on']."','".$data['created_by']."')");
    save_query_in_log();
    return $result;
  }
  ...
  {
    $result = $this->db->query("CALL update_top('".$data['top_id']."','".$data['top_name']."','".$data['top_text']."','".$data['top_type']."','".$data['modified_on']."','".$data['modified_by']."')");
    save_query_in_log();
    return $result;
  }
