...
class Productcostingtype_model extends CI_Model 
{
  ...
  {
    $result = $this->db->query("CALL create_product_costing_type('".$data['product_costing_category_id']."','".$data['product_costing_type']."','".$data['is_percent']."','".$data['math_action']."','".$data['created_on']."','".$data['created_by']."','".$data['type_costing_category']."')");
    save_query_in_log();
    return $result;
  }
  ...
  {
    $result = $this->db->query("CALL update_product_costing_type('".$data['product_costing_type_id']."','".$data['product_costing_category_id']."','".$data['product_costing_type']."','".$data['is_percent']."','".$data['math_action']."','".$data['modified_on']."','".$data['modified_by']."','".$data['type_costing_category']."')");
    save_query_in_log();
    return $result;
  }
