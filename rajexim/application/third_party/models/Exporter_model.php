...
class Exporter_model extends CI_Model 
{
  ...
  {
    $result = $this->db->query("CALL create_exporter('".$data['exporter_name']."','".$data['exporter_address']."','".$data['exporter_country']."','".$data['contact_name']."','".$data['phone_no']."','".$data['gst_no']."','".$data['iec_no']."','".$data['exporter_logo']."','".$data['exporter_sign_file']."','".$data['created_on']."','".$data['created_by']."')");
    save_query_in_log();
    return $result;
  }
  ...
  {
    $result = $this->db->query("CALL update_exporter('".$data['exporter_name']."','".$data['exporter_address']."','".$data['exporter_country']."','".$data['contact_name']."','".$data['phone_no']."','".$data['gst_no']."','".$data['iec_no']."','".$data['exporter_logo']."','".$data['exporter_sign_file']."','".$data['modified_on']."','".$data['modified_by']."','".$data['exporter_id']."')");
    save_query_in_log();
    return $result;
  }
