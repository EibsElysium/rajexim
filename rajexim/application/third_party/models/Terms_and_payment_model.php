...
class Terms_and_payment_model extends CI_Model 
{
  ...
  {
    $result = $this->db->query("CALL create_tap('".$data['tap_name']."','".$data['created_on']."','".$data['created_by']."','".$data['tap_value']."')");
    save_query_in_log();
    return $result;
  }
  ...
  {
    $result = $this->db->query("CALL update_tap('".$data['tap_id']."','".$data['tap_name']."','".$data['modified_on']."','".$data['modified_by']."','".$data['tap_value']."')");
    save_query_in_log();
    return $result;
  }
