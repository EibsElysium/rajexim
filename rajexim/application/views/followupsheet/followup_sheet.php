                     ...
                     <div class="mr-auto">
                        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                           ...
                           <li class="m-nav__item">
                              <a href="<?php echo base_url(); ?>followupsheet" class="m-nav__link">
                           ...
                           <div class="m-portlet__body">
                              <div class="row">
                                 ...
                                 <div class="col-lg-4">
                                    <div class="form-group m-form__group">
                                       <label>Stage</label>
                                       <select class="form-control m_selectpicker" id="stage_id" name="stage_id" multiple>
                                          <option value=''>Select Stage</option>
                                          <?php foreach($followup_stage as $fstage){?>
                                             <option value="<?php echo $fstage['followup_sheet_stage_id'];?>"><?php echo $fstage['followup_sheet_stage'];?></option>
                                          <?php }?>
                                       </select>
                                    </div>
                                 </div>
                                 ...
                                 <!-- <div class="col-lg-4">
                                    <div class="form-group m-form__group">
                                       ...
                                       name="bo_date" id="bo_date"/>
                                          <div class="input-group-append">
                                                <button class="btn btn-primary" onclick="getBOFollowupsheet();">Go</button>
                                          </div>
                                       </div>
                                    </div>
                                 ...
                                 <div class="col-lg-4">
                                   <div class="form-group m-form__group">
                                      ...
                                      <div class="row">
                                         ...
                                         <div class="col-lg-1">
                                            <div class="input-group-append">
                                                  <input onclick="getBOFollowupsheet();" value="Go" class="btn btn-primary inp" type="submit">
                                            </div>
                                         </div>
                                      </div>
...
var title = $('title').text() + ' | ' + 'Followup Sheet';
$(document).attr("title", title); 

function getBOFollowupsheet()
{
   var dtrange_from = $('#dtrange_from').val();
   var dtrange_to = $('#dtrange_to').val();
   var eid = $('#exporter_id').val();
   var stg = $('#stage_id').val();
   if(dtrange_from!='' && dtrange_to!='')
   {
      $('#bo_date_err').html('');
      $.ajax({
         type: "POST",
         url: baseurl+'followupsheet/getBOFollowupsheet',
         async: false,
         data: "dtrange_from="+dtrange_from+"&dtrange_to="+dtrange_to+"&eid="+eid+"&stg="+stg,
         dataType: "html",
