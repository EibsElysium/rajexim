                                    ...
                                    <div class="panel-body">
                                        <div class="mar-btm pad-btm bord-btm row">
                                          ...
                                          <div class="col-sm-5 sm_action_btn_size">
                                            <?php if($is_lead > 0){ 
                                              if($imap_email_lists['attachment_name_string'] != ''){ ?>
                                            <button type="button" class="btn btn-primary" onclick="import_attachments_of_lead(<?php echo $imap_email_lists['msgno']; ?>, 'Inbox', <?php echo $contact_book_id; ?>);">
                                                <i class="la la-download"></i>&nbsp;&nbsp;Add Lead Documents
                                            </button>
                                            <?php } } ?>
                                          <?php if($is_alibaba_mail == 1){ ?>
                                            <button type="button" class="btn btn-primary" onclick="import_into_lead(<?php echo $imap_email_lists['msgno']; ?>, 'Inbox');">
                                                <i class="la la-plus"></i>&nbsp;&nbsp;Add as Lead alibaba
                                            </button>
                                          <?php } else{ 
                                            if ($user_mail_already_exist == 1){
                                            ?>
                                            <button type="button" class="btn btn-primary" onclick="normal_mail_import_into_lead(<?php echo $imap_email_lists['msgno']; ?>, 'Inbox');">
                                         ...
                                         <!--  <span class="pull-right" onclick="get_another_part_of_list(<?php echo $second_index; ?>,<?php echo $first_index - 1; ?>,<?php echo $start; ?>,<?php echo $end; ?>);"><i class="fa fa-arrow-left" style="font-size: 20px;cursor: pointer;"></i></span> -->
                                            <button type="button" class="btn btn-primary pull-right" onclick="get_another_part_of_list(<?php echo $second_index; ?>,<?php echo $first_index - 1; ?>,<?php echo $start; ?>,<?php echo $end; ?>,'<?php echo $imap_email_lists['attachment_name_string']; ?>');">
                                                ...
                                                <div class="media">
                                                  ...
                                                  <div class="media-body">
                                                      ...
                                                      <ul class="dropdown-menu" style="padding: 14px;">
                                                          <li>FROM : <?php echo $imap_email_lists['msg_from'][0]->mailbox.'@'.$imap_email_lists['msg_from'][0]->host; ?></li>
                                        ...
                                        <div class="pad-ver bord-ver">
                                          <?php if($imap_email_lists['attachment_name_string'] != ''){ ?>
                                            ...
                                            <a href="<?php echo base_url(); ?>assets/mail_box_view_attachment/<?php echo $exp_attach[$i]; ?>" target = "_blank" class="btn btn-primary"><?php echo $exp_attach[$i]; ?>
                                            </a>&nbsp;&nbsp;
                                          <?php } } ?>
                                        </div>
                                        <!--===================================================-->
