    ...
    <!--  Search Ends Here -->
	        ...
	        <div class="panel">
	            <div id="mailbox-email-list" class="panel-body">
	                <h1 class="page-header text-overflow pad-btm">Drafts
                        ...
                        <?php 
                          ...
                          { ?>
	                       ...
	                       <button type="button" class="btn btn-default" >
	                         ...
	                         onclick="get_another_part_of_draft_list(<?php echo $displayed_mail_list_count + ($per_page * 2); ?>,<?php echo (($displayed_mail_list_count + $per_page) < $emails_count) ? $displayed_mail_list_count + $per_page : $emails_count; ?>,<?php echo $start - $per_page; ?>,<?php echo $end - $per_page; ?>,<?php echo $emails_count; ?>);"></i>
	                       </button>
                         <?php } ?>
	                      <?php 
                       		...
                       		{ ?>
                       			 <button type="button" class="btn btn-default">
			                          <i class="mailbox-psi-arrow-right" onclick="get_another_part_of_draft_list(<?php echo $displayed_mail_list_count - 1 ?>,<?php echo ($displayed_mail_list_count > $per_page) ? $displayed_mail_list_count - $per_page : 1; ?>,<?php echo $end+1; ?>, <?php echo $end + $per_page; ?>,<?php echo $emails_count; ?>);"></i>
			                  	</button>
                       		<?php } ?>
	                   </div>
	                </div>
                                                        ...
                                                        { ?>
                                         				...
                                         				<?php
                                                           ...
                                                           // echo COUNT($explode_msg);
                                                            ...
                                                            ?>
								                            <!--Mail list item-->
                                                            <li onclick="draft_imap_mailbox_view(<?php echo $msg_no; ?>, '[Gmail]/Drafts', <?php echo $start; ?>, <?php echo $end; ?>, <?php echo $per_page; ?>,<?php echo $emails_count; ?>,<?php echo $first_index; ?>,<?php echo $second_index; ?>);" class="<?php echo ($seen == 0) ? 'mail-list-unread' : ''; ?> <?php echo $flag_star; ?> mail-attach ">
