...
<div class="panel">
    <div class="panel-body">
        ...
        <!--Input form-->
    <form role="form" class="form-horizontal send_reply_to_all_ajax_form" enctype="multipart/form-data" onsubmit="return send_compose_validation();">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-11">
                    <input type="text" id="cc_email" name="cc_email" class="form-control" value="<?php if($imap_email_lists['cc_address'] != '') { echo $imap_email_lists['cc_address']; } ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-lg-1 control-label text-left" for="inputBcc">Bcc</label>
                <div class="col-lg-11">
                    <input type="text" id="bcc_email" name="bcc_email" class="form-control" value="<?php if($imap_email_lists['bcc_address'] != '') { echo $imap_email_lists['bcc_address']; } ?>">
                </div>
            </div>
            <div class="form-group">
...
<script type="text/javascript">
  ...
  $('.selectpicker').selectpicker();
    ...
    $("form.send_reply_to_all_ajax_form").submit(function(e) {
        e.preventDefault();  
        if(re_err == 0){
