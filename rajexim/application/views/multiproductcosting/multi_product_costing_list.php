                     ...
                     <div class="col-xl-12">
                        <div class="m-portlet m-portlet--mobile ">
                           <div class="m-portlet__head">
                              ...
                              <div class="m-portlet__head-tools">
                                 <ul class="m-portlet__nav">
                                    ...
                                    <li class="m-portlet__nav-item">
                                       <a href="<?php echo base_url(); ?>multiproductcosting/multi_product_costing_add" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air">
                                          <span>
                                             <i class="la la-plus"></i>
                                             <span>Create Multi Product Costing - G</span>
                                          </span>
                                       </a>
                                    </li>
                                    <?php }?>
                           ...
                           <div class="m-portlet__body">
                              ...
                              <form method="POST" action="<?php echo base_url();?>multiproductcosting">
                                             ...
                                             <div class="row">
                                                ...
                                                <div class="col-lg-1">
                                                   <div class="input-group-append">
                                                         <input id="goButton" name="goButton" value="Go" class="btn btn-primary inp" type="buton" onclick="submit_product_costing_form('filter');">
                                                   </div>
                                                </div>
                                             </div>
...
function submit_product_costing_form(diff) {
   ...
   $.ajax({
      url:baseurl+'multiproductcosting/multi_product_costing_result_list',
      type:'POST',
      data:{'country_id':country_id,'user_id':user_id,'fbase':fbase,'fquarter':fquarter,'ypick':ypick,'searchChange':searchChange,'dtrange_from' : dtrange_from, 'dtrange_to' : dtrange_to, 'pagecount' : pagecount, 'search_val' : search_val, 'current_pagination_index' : current_pagination_index,'perpage':perpage},
      dataType: 'html',
