                                 ...
                                 <form class="m-form m-form--label-align-left- m-form--state-" id="m_form" method="POST" action="<?php echo base_url(); ?>quote/create_quote" onsubmit="return quote_validation();">
                                    ...
                                    <div class="m-portlet__body">
                                       ...
                                       <fieldset>
                                          ...
                                          <div id="mcontent10">
                                             <?php $tamt = 0;$i=0; $cif = explode(',', $cifvalue);foreach($multi_product_costing_input_list as $mpcpinput){
                                                ...
                                                $totalamt = $mpcpinput['multi_product_costing_input']*$cif[$i];?>
                                                      ...
                                                      <div class="row">
                                                         ...
                                                         <div class="col-lg-2">
                                                            <div class="form-group m-form__group">
                                                               ...
                                                               <input type="text" id="specification<?php echo $i;?>" name="specification[]" class="form-control" placeholder="Specification" value="<?php echo $mpcpinput['product_item_spec'];?>" readonly>
                                                            ...
                                                            <div class="form-group m-form__group">
                                                               ...
                                                               <select class="form-control m-bootstrap-select m_selectpicker" id="sku_unit_id<?php echo $i;?>" name="sku_unit_id[]" data-live-search="true"> 
                                                                  ...
                                                                  <?php foreach($product_unit as $punit){?>
                                                                     <option value="<?php echo $punit['product_unit_id'];?>" <?php echo $punit['product_unit_id'] == $mpcpinput['sku_unit_id']?'selected':'';?>><?php echo $punit['product_unit'];?></option>
                                                                  <?php }?>
                                                               </select>
                                                         ...
                                                         <div class="col-lg-2">
                                                            <div class="form-group m-form__group">
                                                               ...
                                                               <input type="text" id="quantity<?php echo $i;?>" name="quantity[]" class="form-control" placeholder="Enter Quantity" value="<?php echo $mpcpinput['multi_product_costing_input'];?>" onfocus="this.select();" onkeypress="return isNumberKey(event,this);" onkeyup="getAmount(<?php echo $i;?>);" readonly>
                                                         ...
                                                         <div class="col-lg-2">
                                                            <div class="form-group m-form__group">
                                                               ...
                                                               <input type="text" id="rate<?php echo $i;?>" name="rate[]" class="form-control" placeholder="Enter Rate" value="<?php echo $cif[$i];?>" onfocus="this.select();" onkeypress="return isNumberKey(event,this);" onkeyup="getAmount(<?php echo $i;?>);" readonly>
