                  ...
                  <div class="row">
                     <div class="col-xl-12">
                        <div class="m-portlet m-portlet--mobile ">
                           ...
                           <form class="" method="POST"  enctype="multipart/form-data" action="<?php echo base_url(); ?>employee/create_employee" onsubmit="return employee_validation();">
                                ...
                                <fieldset>
                                  ...
                                  <div class="col-lg-9">
                                    <div class="row">
                                      ...
                                      <input type="text" class="form-control m-input" name="employee_no" id="employee_no" readonly value="<?php echo $employee_no; ?>">
                                        </div>
                                      </div>
                                    </div>
                                    <div class="row">
                                      <div class="col-lg-6">
                                        <div class="form-group m-form__group">
                                          ...
                                          <input type="text" class="form-control m-input m-input--square" placeholder="Enter First Name" name="first_name" id="first_name">
                                      ...
                                      <div class="col-lg-6">
                                        <div class="form-group m-form__group">
                                          ...
                                          <input type="text" class="form-control m-input m-input--square" placeholder="Enter Last Name" name="last_name" id="last_name">
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="row">
                                      <div class="col-lg-6">
                                        <div class="form-group m-form__group">
                                          ...
                                          <input type="text" class="form-control m-input m-input--square" placeholder="Enter Contact No" name="contact_no" id="contact_no" onkeypress="return isNumber(event,'contact_no_err');" onkeyup="cno_unique(this.value);">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group m-form__group">
                                          ...
                                          <select class="custom-select form-control" name="designation_id" id="designation_id">
                                            ...
                                            <?php foreach ($designation_list as $value) { ?>
                                              <option value="<?php echo $value['designation_id']; ?>"><?php echo $value['designation'];?></option>
                                            <?php } ?>
                                          </select>
                                      ...
                                      <div class="col-lg-6">
                                        <div class="form-group m-form__group">
                                          ...
                                          <input type="text" class="form-control m-input m-input--square" placeholder="Enter Area" name="area" id="area">
                                    ...
                                    <div class="row">
                                      <div class="col-lg-6">
                                        <div class="form-group m-form__group">
                                          <label>Address</label>
                                          <textarea class="form-control m-input" id="address" name="address" rows="3"></textarea>
                                        </div>
                                      </div>
                                    </div>
                                          ...
                                          <div>
                                             <div class="fileinput fileinput-new" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail img-file">
                                                   <img src="<?php echo base_url(); ?>assets/images/employee_profile/defaultprofile.jpg" width="200" class="img-responsive" height="150" alt="logo">
                                                </div>
...
var title = $('title').text() + ' | ' + 'Employee Create';
...
function employee_validation()
  ...
  var er=0
  function cno_unique(val)
  {
      //var baseurl= $("#baseurl").val();
      $.ajax({
      type:"POST",
      url:baseurl+'employee/unique_cno',
      data:{'value':val},
      cache: false,
      dataType: "html",
