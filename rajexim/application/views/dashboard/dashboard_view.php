                        ...
                        <div class="m-portlet m-portlet--full-height noti_pro_block">
                           <div class="m-portlet__head">
                              <div class="m-portlet__head-caption">
                                 <div class="m-portlet__head-title">
                                    <h3 class="m-portlet__head-text">
                                       <span id="pro_top_or_least">Top <?php $dash_noti = get_dashboard_settings_info(); echo $dash_noti->max_product_count; ?> Products </span>
                              ...
                              <div class="m-portlet__head-tools">
                                 ...
                                 &nbsp;&nbsp;
                                 <input type="text" class="form-control finance_year" id="top_least_pro_year_filt" value="<?php $curr_month = date('m'); if($curr_month > '03'){ echo date('Y').'-'.date('Y',strtotime('+1 year')); } else { echo date('Y',strtotime('-1 year')).'-'.date('Y'); } ?>" onchange = "get_product_chart_by_filter();">  
                              </div>
                           </div>
                       ...
                       <div class="m-portlet__head">
                          ...
                          <div class="m-portlet__head-tools">
                            <div class="row">
                              ...
                              <div class="col-lg-4 expand_width_funnel">
                                <input type="text" class="form-control finance_year" id="funnel_year" value="<?php $curr_month = date('m'); if($curr_month > '03'){ echo date('Y').'-'.date('Y',strtotime('+1 year')); } else { echo date('Y',strtotime('-1 year')).'-'.date('Y'); } ?>" onchange="get_funnel_report_by_year();">
                              </div>   
                            </div>
                    ...
                    <div class="m-portlet m-portlet--full-height ">
                       <div class="m-portlet__head">
                          ...
                          <div class="m-portlet__head-tools">
                             ...
                             &nbsp;&nbsp;
                             <input type="text" class="form-control finance_year" id="top_least_ls_year_filt" value="<?php $curr_month = date('m'); if($curr_month > '03'){ echo date('Y').'-'.date('Y',strtotime('+1 year')); } else { echo date('Y',strtotime('-1 year')).'-'.date('Y'); } ?>" onchange = "get_lead_source_chart_by_filter();">        
                          </div>
                       </div>
                       <div class="m-portlet__body">
                              ...
                              <div class="m-portlet__head-tools"> 
                                <div class="row">
                                  ...
                                  <div class="col-lg-2 expand_width lead_filt_year" >
                                      <input type="text" class="form-control finance_year" id="lead_financial_year" value="<?php $curr_month = date('m'); if($curr_month > '03'){ echo date('Y').'-'.date('Y',strtotime('+1 year')); } else { echo date('Y',strtotime('-1 year')).'-'.date('Y'); } ?>" onchange="get_dynamic_lead_based_on_product();">
                                  </div>
                                  <div class="col-lg-2 expand_width lead_filt_year">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-2 expand_width">
                                    ...
                                    <div class="col-lg-2 expand_width oppo_filt_year" >
                                      ...
                                      get_dynamic_opportunity_based_on_industry();" value="<?php $curr_month = date('m'); if($curr_month > '03'){ echo date('Y').'-'.date('Y',strtotime('+1 year')); } else { echo date('Y',strtotime('-1 year')).'-'.date('Y'); } ?>">
                                    </div>
                                    <div class="col-lg-2 expand_width oppo_filt_year">
                              ...
                              <div class="m-portlet__head-tools">                               
                                <div class="row">
                                  ...
                                  <div class="col-lg-2 expand_width quote_filt_year" >
                                      <input type="text" class="form-control finance_year" id="quote_financial_year" value="<?php $curr_month = date('m'); if($curr_month > '03'){ echo date('Y').'-'.date('Y',strtotime('+1 year')); } else { echo date('Y',strtotime('-1 year')).'-'.date('Y'); } ?>" onchange="get_dynamic_quote_based_on_industry();">
                                  </div>
                                  <div class="col-lg-2 expand_width quote_filt_year">
                           ...
                           <div class="m-portlet__head">
                              ...
                              <div class="m-portlet__head-tools">                               
                                ...
                                <?php }?>
                                  ...
                                  &nbsp;&nbsp;
                                <input type="text" class="form-control finance_year" id="quote_quat_fin_year_target" name="quote_quat_fin_year_target" value="<?php $curr_month = date('m'); if($curr_month > '03'){ echo date('Y').'-'.date('Y',strtotime('+1 year')); } else { echo date('Y',strtotime('-1 year')).'-'.date('Y'); } ?>">     
                              </div>
                           </div>
                           <div class="m-portlet__body">
                                 <div class="row">
                              ...
                              <div class="m-portlet__head-tools">                               
                                <div class="row">
                                  ...
                                  <div class="col-lg-2 expand_width pi_filt_year" >
                                      <input type="text" class="form-control finance_year" id="pi_financial_year" value="<?php $curr_month = date('m'); if($curr_month > '03'){ echo date('Y').'-'.date('Y',strtotime('+1 year')); } else { echo date('Y',strtotime('-1 year')).'-'.date('Y'); } ?>" onchange="get_dynamic_pi_based_on_pi_stage();">
                                  </div>
                                  <div class="col-lg-2 expand_width pi_filt_year">
                        ...
                        <div class="m-portlet m-portlet--full-height ">
                           <div class="m-portlet__head">
                              ...
                              <div class="m-portlet__head-tools">                               
                                ...
                                <?php }?>                   
                                    &nbsp;&nbsp;
                                    <input type="text" class="form-control finance_year" id="pi_bo_fin_year" name="pi_bo_fin_year" value="<?php $curr_month = date('m'); if($curr_month > '03'){ echo date('Y').'-'.date('Y',strtotime('+1 year')); } else { echo date('Y',strtotime('-1 year')).'-'.date('Y'); } ?>" onchange="getPIBOList();">   
                              </div>
                           </div>
                            <div class="m-portlet__body">
                               <div class="row">
