                        ...
                        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                           ...
                           <li class="m-nav__item">
                              <a href="" class="m-nav__link">
                                 <span class="m-nav__link-text">Edit Quote</span>
                              </a>
                           </li>
                        </ul>
                     </div>
                  ...
                  <div class="row">
                     <div class="col-xl-12">
                        ...
                        <div class="m-portlet">
                              ...
                              <div class="m-portlet__head-caption">
                                 <div class="m-portlet__head-title">
                                    <h3 class="m-portlet__head-text">
                                       Edit Quote - <?php echo $quote_list->quote_no;?>
                                    </h3>
                                 </div>
                              </div>
                           ...
                           <!--end: Portlet Head-->
                                 <form class="m-form m-form--label-align-left- m-form--state-" id="m_form" method="POST" action="<?php echo base_url(); ?>quote/update_quote" onsubmit="return quote_validation();">
                                    <input type="hidden" id="quote_id" name="quote_id" value="<?php echo $quote_list->quote_id;?>">
                                    <input type="hidden" id="parent_quote_id" name="parent_quote_id" value="<?php echo $quote_list->parent_quote_id;?>">
                                    <input type="hidden" id="qno" name="qno" value="<?php echo $quote_list->quote_no;?>">
                                    <input type="hidden" id="is_local" name="is_local" value="<?php echo $quote_list->is_local;?>">
                                    <!--begin: Form Body -->
...
<br><div class="row">
                                             ...
                                             <div class="col-lg-3">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <select class="form-control m-bootstrap-select m_selectpicker" data-live-search="true" id="prod_costing_id" name="prod_costing_id" onchange="changeProductCostingValue(this.value);"> 
                                                      ...
                                                      {?>
                                                         <option value="<?php echo $pclist['product_costing_id'];?>" <?php echo $pclist['product_costing_id']==$quote_list->product_costing_id?'selected':'';?>><?php echo $pclist['product_costing_no'];?></option>
                                                      <?php }?>
                                                   </select>
                                             ...
                                             <div class="col-lg-3">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <select class="form-control m-bootstrap-select m_selectpicker" id="stage_type" name="stage_type" data-live-search="true" onchange="changeStage(this.value);">
                                                       ...
                                                       <option value="fob" <?php echo $quote_list->stage_type=='fob'?'selected':'';?>>FOB</option>
                                                       <option value="cnf" <?php echo $quote_list->stage_type=='cnf'?'selected':'';?>>CNF</option>
                                                    </select>
                                                   <span class="text-danger" id="stage_type_err"></span>
                                                </div>
                                             </div>

                                             <div class="col-lg-3" id="cnfstage" style="<?php echo $quote_list->stage_type=='fob'?'display:none':'';?>">
                                                <div class="form-group m-form__group">
                                             ...
                                             <div class="col-lg-3" id="fobstage" style="<?php echo $quote_list->stage_type=='cnf'?'display:none':'';?>">
                                                <div class="form-group m-form__group">
                                                   <label>Stage<span class="text-danger">*</span></label>
                                          ...
                                          <div class="row">
                                                ...
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <select class="form-control m-bootstrap-select m_selectpicker" data-live-search="true" id="exporter_id" name="exporter_id" onchange="getExporterLogo(this.value);"> 
                                                      ...
                                                      <?php foreach ($exporter_list as $vflist) {
                                                         if($vflist['status']==0){ ?>
                                                         <option value="<?php echo $vflist['exporter_id']; ?>" <?php echo $quote_list->exporter_id == $vflist['exporter_id']?'selected':'';?>><?php echo $vflist['exporter_name']; ?></option>
                                                      <?php }}?>
                                                   </select>
                                             ...
                                             <div class="col-lg-3">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <div style="border: 1px solid #ccc;padding: 5px;">
                                                      <img src="<?php echo base_url();?>exporterlogo/<?php echo str_replace(' ', '_', $quote_list->exporter_logo);?>" id="exporter_logo" height="75" width="100%"  alt="logo" style="object-fit: contain;">
                                                   </div>
                                                </div>
                                             </div>
                                             <div class="col-lg-3">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <input type="text" id="quote_no" name="quote_no" class="form-control"  readonly value="<?php echo $quote_list->quote_no;?>">
                                             ...
                                             <div class="col-lg-3">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <input type="text" id="subject" name="subject" class="form-control"  placeholder="Enter Subject" value="<?php echo $quote_list->subject;?>">
                                          ...
                                          <div class="row">
                                             <div class="col-lg-3">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <input type="text" id="alter_created_date" onblur="createdate_change_to_commondate();" name="alter_created_date" class="form-control m_datepicker_1" value="<?php $qdate = explode('-', $quote_list->created_date); echo $qdate[1].'/'.$qdate[2].'/'.$qdate[0];?>">
                                                   <input type="hidden" id="created_date" name="created_date"  value="<?php $qdate = explode('-', $quote_list->created_date); echo $qdate[1].'/'.$qdate[2].'/'.$qdate[0];?>">
                                             ...
                                             <div class="col-lg-3">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <input type="text" id="alter_valid_till" onblur="validtill_change_to_commondate();" name="alter_valid_till" class="form-control m_datepicker_1" value="<?php $qdate = explode('-', $quote_list->valid_till); echo $qdate[1].'/'.$qdate[2].'/'.$qdate[0];?>">
                                                   <input type="hidden" id="valid_till" name="valid_till" value="<?php $qdate = explode('-', $quote_list->valid_till); echo $qdate[1].'/'.$qdate[2].'/'.$qdate[0];?>">
                                                ...
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <select class="form-control custom-select" id="quote_stage_id" name="quote_stage_id"> 
                                                      ...
                                                      <?php foreach ($quote_stage_list as $vflist) {
                                                         if($vflist['status']==0){ ?>
                                                         <option value="<?php echo $vflist['quote_stage_id']; ?>" <?php echo $quote_list->quote_stage_id == $vflist['quote_stage_id']?'selected':'';?>><?php echo $vflist['quote_stage']; ?></option>
                                                      <?php }}?>
                                                   </select>
                                             ...
                                             <div class="col-lg-3">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <input type="text" class="form-control" id="price_validity" name="price_validity" placeholder="Enter Price Validity" value="<?php echo $quote_list->price_validity;?>">
                                          ...
                                          <div class="row">
                                                ...
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <select class="form-control m-bootstrap-select m_selectpicker" id="lead_id" name="lead_id" data-live-search="true" onchange="getLeadDetails(this.value);"> 
                                                      ...
                                                      <?php foreach ($opportunity_list as $vflist) { ?>
                                                         <option value="<?php echo $vflist['lead_id']; ?>" <?php echo $quote_list->lead_id == $vflist['lead_id']?'selected':'';?>><?php echo $vflist['lead_name']; ?></option>
                                                      <?php }?>
                                                   </select>
                                             ...
                                             <div class="col-lg-4">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <input type="text" id="organization_name" name="organization_name" class="form-control"  readonly value="<?php echo $quote_list->company_name;?>">
                                                </div>
                                             </div>
                                             <div class="col-lg-4">
                                                <div class="form-group m-form__group">
                                                   <label>Country</label>
                                                   <input type="text" name="" id="country" name="country" class="form-control"  readonly value="<?php echo $quote_list->country_name;?>">
                                                   <span class="text-danger"></span>
                                                </div>
                                             </div>
                                          </div>
                                          <div class="row">
                                             <div class="col-lg-12" id="snote2">
                                                <div class="form-group m-form__group"> 
                                                   <label>Address <i class="fa fa-power-off show_snote2"></i> </label>
                                                   <textarea class="form-control snote"  cols="40" id="address" name="address"  readonly><?php echo $quote_list->address;?></textarea>
                                                </div>
                                             </div>
                                          </div>
                                          <div class="row">
                                             <div class="col-lg-3">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <input type="text" id="email_id" name="email_id" class="form-control"  readonly value="<?php echo $quote_list->email_id;?>">
                                                </div>
                                             </div>
                                             <div class="col-lg-3">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <input type="text" id="phone_no" name="phone_no" class="form-control"  readonly value="<?php echo $quote_list->contact_no;?>">
                                                </div>
                                             </div>
                                             <div class="col-lg-3">
                                                <div class="form-group m-form__group">
                                             ...
                                             <div class="col-lg-3">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <input type="text" id="assigned_to" name="assigned_to" class="form-control"  readonly value="<?php echo $quote_list->lead_assigned_name;?>">
                                                </div>
                                             </div>
                                          </div>
                                                ...
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <select class="form-control m-bootstrap-select m_selectpicker" id="vessel_flight_id" name="vessel_flight_id" data-live-search="true" onchange="getFromPort(this.value);"> 
                                                      ...
                                                      <?php foreach ($vessel_flight_list as $vflist) {
                                                         if($vflist['status']==0){ ?>
                                                         <option value="<?php echo $vflist['vessel_flight_id']; ?>" <?php echo $quote_list->vessel_flight_id == $vflist['vessel_flight_id']?'selected':'';?>><?php echo $vflist['vessel_flight_name']; ?></option>
                                                      <?php }}?>
                                                   </select>
                                                ...
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <select class="form-control m-bootstrap-select m_selectpicker" id="to_port" name="to_port" data-live-search="true"> 
                                                      ...
                                                      <?php foreach ($port_list as $vflist) {
                                                         if($vflist['status']==0){ ?>
                                                         <option value="<?php echo $vflist['port_id']; ?>" <?php echo $quote_list->to_port == $vflist['port_id']?'selected':'';?>><?php echo $vflist['port_name']; ?> - <?php echo $vflist['port_city']; ?> - <?php echo $vflist['port_country']; ?></option>
                                                      <?php }}?>
                                                   </select>
                                                ...
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <select class="form-control m-bootstrap-select m_selectpicker" id="price_term_id" name="price_term_id" data-live-search="true"> 
                                                      ...
                                                      <?php foreach ($price_term_list as $vflist) {
                                                         if($vflist['status']==0){ ?>
                                                         <option value="<?php echo $vflist['price_term_id']; ?>" <?php echo $quote_list->price_term_id == $vflist['price_term_id']?'selected':'';?>><?php echo $vflist['price_term_name']; ?></option>
                                                      <?php }}?>
                                                   </select>
                                       ...
                                       <fieldset>
                                          ...
                                          <div class="row">
                                                ...
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <select class="form-control m-bootstrap-select m_selectpicker" id="currency_id" name="currency_id" data-live-search="true" onchange="getCurrencyCode(this.value);"> 
                                                      ...
                                                      <?php foreach ($currency_list as $vflist) {
                                                         if($vflist['status']==0){ ?>
                                                         <option value="<?php echo $vflist['currency_id']; ?>" <?php echo $quote_list->currency_id == $vflist['currency_id']?'selected':'';?>><?php echo $vflist['currency_name']; ?> - <?php echo $vflist['currency_code']; ?></option>
                                                      <?php }}?>
                                                   </select>
                                             ...
                                             <div class="col-lg-3">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <input type="text" class="form-control" id="rate" name="ratec" placeholder="Enter Rate" value="<?php echo $quote_list->rate;?>">
                                          ...
                                          <div id="mcontent10">
                                             <?php $i=0; foreach($quote_product_list as $qplist){

                                                $displayname = $this->Productcosting_model->get_product_item_display_name_by_id($qplist['product_item_id']);

                                                if(count($displayname)>0)
                                                {
                                                   $st = '<option value="">Select Display Name</option>';
                                                   if($qplist['product_item_display_name_id']!=0)
                                                   {
                                                        foreach ($displayname as $prod) {
                                                         if($prod["product_item_display_name_id"] == $qplist['product_item_display_name_id'])
                                                            $st.='<option value='.$prod["product_item_display_name_id"].' selected>'.$prod["display_name"].'</option>';
                                                         else
                                                   ...
                                                   <div class="row">
                                                      ...
                                                      <div class="col-lg-2">
                                                         <div class="form-group m-form__group">
                                                            ...
                                                            <select class="form-control m-bootstrap-select m_selectpicker" id="product_item_id<?php echo $i;?>" name="product_item_id[]" data-live-search="true" onchange="getItemSpec(this.value,<?php echo $i;?>);"> 
                                                      ...
                                                      <div class="col-lg-2" id="snote1">
                                                         <div class="form-group m-form__group">
                                                            <label>Specification<span class="text-danger">*</span><i class="fa fa-power-off show_snote"></i></label>
                                                            <!-- <input type="text" id="specification<?php //echo $i;?>" name="specification[]" class="form-control" placeholder="Specification" readonly value="<?php //echo $qplist['product_item_spec'];?>"> -->
                                                      ...
                                                      <div class="col-lg-2">
                                                         <div class="form-group m-form__group">
                                                            ...
                                                            <input type="text" id="quantity<?php echo $i;?>" name="quantity[]" class="form-control" placeholder="Enter Quantity" onfocus="this.select();" onkeypress="return isNumberKey(event,this);" onkeyup="getAmount(<?php echo $i;?>);" value="<?php echo $qplist['quantity'];?>">
                                                      ...
                                                      <div class="col-lg-2">
                                                         <div class="form-group m-form__group">
                                                            ...
                                                            <input type="text" id="rate<?php echo $i;?>" name="rate[]" class="form-control" placeholder="Enter Rate" onfocus="this.select();" onkeypress="return isNumberKey(event,this);" onkeyup="getAmount(<?php echo $i;?>);" value="<?php echo $qplist['rate'];?>">
                                                            <span class="text-danger" id="rate_err<?php echo $i;?>"></span>
                                                         </div>
                                                      </div>
                                                      
                                                      <div class="col-lg-2" <?php echo $quote_list->is_local==0?"style=display:none;":'';?>>
                                                         <div class="form-group m-form__group">
                                                            <label>Tax Type<span class="text-danger">*</span></label>
                                                            <select class="form-control m-bootstrap-select m_selectpicker" id="tax_type<?php echo $i;?>" name="tax_type[]" data-live-search="true" onchange="getAmount(<?php echo $i;?>);"> 
                                                               <option value='0' <?php echo $qplist['tax_type']==0?"selected":'';?>>CGST/SGST</option>
                                                               <option value='1' <?php echo $qplist['tax_type']==1?"selected":'';?>>IGST</option>
                                                            </select>
                                                      ...
                                                      <div class="col-lg-2" <?php echo $quote_list->is_local==0?"style=display:none;":'';?>>
                                                         <div class="form-group m-form__group">
                                                            ...
                                                            <input type="text" id="tax_percent<?php echo $i;?>" name="tax_percent[]" class="form-control" placeholder="Enter Tax %" value="<?php echo $qplist['tax_percent'];?>" onfocus="this.select();" onkeypress="return isNumberKey(event,this);" onkeyup="getAmount(<?php echo $i;?>);">
                                          ...
                                          <div class="row mt_25px">
                                             ...
                                             <div class="col-lg-3">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <input type="text" id="grand_total" name="grand_total" class="form-control" readonly value="<?php echo $quote_list->grand_total;?>">
                                                </div>
                                             </div>
                                          </div>
...
function validtill_change_to_commondate()
{
   ...
   var title = $('title').text() + ' | ' + 'Edit Quote';
