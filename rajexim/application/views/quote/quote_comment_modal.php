...
<div class="modal-dialog modal-lg" role="document">
   <div class="modal-content">
      ...
      <div class="modal-body" style="padding: 0px;">
         <?php if (count($quote_comments_list)>0){ ?>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="row page-header">
                     <div class="col-md-3"> <h5 style="padding-left: 15px;padding-top: 13px;"><?php echo count($quote_comments_list); ?> Comment<?php echo(count($quote_comments_list) == 1) ? '' : 's' ?></h5> </div>
                                      ...
                                      <div class="row no-gutters">
                                              ...
                                              <div class="chat-container">
                                                  <ul class="chat-box chatContainerScroll" id="comments_block">
                                                   <?php foreach($quote_comments_list as $botlist){ 
       ...
       <?php } ?>
         <form class="m-form m-form--label-align-left- m-form--state-" id="m_form" method="POST" action="<?php echo base_url(); ?>Quote/create_quote_comments">
      ...
      <div class="modal-footer">
        <button type="button" onclick="quote_comment_validation();" id="add_wl_btn" class="btn btn-primary">Add Comment</button>
...
function quote_comment_validation(){
    var err = 0;
