                              ...
                              if(!empty($lead_source_lists))
                              {
                                 foreach ($lead_source_lists as  $lead_source_list) { if($lead_source_list->status == 0){ ?>
                                    <optgroup label="<?php echo $lead_source_list->lead_source; ?>">
                                       ...
                                       ?>
                                       <option <?php echo ($lead_source_list->lead_source_id == $lead_edit->lead_source_id) ? 'selected' : ''; ?> value="<?php echo $sub_lead->sub_lead_source_id; ?>"><?php echo $sub_lead->sub_lead_source; ?></option>
                                       <?php } ?>
                                    </optgroup>
                     ...
                     <div class="form-group m-form__group">
                        ...
                        <select class="form-control m-bootstrap-select m_selectpicker" data-live-search="true" name="lead_status" id="e_lead_status"> 
                          ...
                          <?php
                              ...
                              {
                                 foreach ($oppo_status_lists as $key => $oppo_status_list) { if($oppo_status_list->status == 0){ ?>
                                    <option value="<?php echo $oppo_status_list->oppo_status_id; ?>" <?php echo ($oppo_status_list->oppo_status_id == $lead_edit->lead_status_id) ? 'selected' : ''; ?> ><?php echo $oppo_status_list->oppo_status; ?></option>
                                 <?php } }
                              }
                           ?>
                        </select>
