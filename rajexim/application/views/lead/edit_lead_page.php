    ...
    <div class="m-grid m-grid--hor m-grid--root m-page">
      ...
      <!-- begin::Body -->
            ...
            <div class="m-grid__item m-grid__item--fluid m-wrapper">
               ...
               <div class="m-content">
                  <h3 class="text-theme" style="background: #fff;">Update Lead</h3>
                                   ...
                                   <div class="row">
                                      ...
                                      <div class="col-lg-4" id="snote1">
                                         <div class="form-group m-form__group">
                                            ...
                                            <textarea class="form-control snote" name="address" id="e_address" placeholder="Enter Address"><?php echo ($contact_book_info->address) ? $contact_book_info->address : ''; ?></textarea>
                                   ...
                                   <div class="row">
                                      <div class="col-lg-4">
                                         <div class="form-group m-form__group">
                                            ...
                                            <input type="text" class="form-control m-input m-input--square" placeholder="Enter Contact No" id="e_contact_no" name="contact_no" maxlength="20" onblur="contact_no_unique(this.value);" value="<?php echo ($contact_book_info->contact_no) ? $contact_book_info->contact_no : ''; ?>">
                                   ...
                                   <div id="contact_person_block_append">
                                    ...
                                    <div id="address_block_append">
                                      <?php if(count($shipping_addresses) > 0){ 
                                        ...
                                        ?>
                                        <div class="row" id="address_block_<?php echo $key; ?>">
                                          <input type="hidden" name="shipping_address_id[]" value="<?php echo $shipping_address->lead_shipping_address_id; ?>">
                                           <div class="col-lg-11">
                                              <div class="form-group m-form__group">
                                                 <label>Shipping Address</label>
                                                 <input type="text" class="form-control m-input m-input--square" placeholder="Enter Shipping Address" id="shipping_address_<?php echo $key; ?>" value="<?php echo $shipping_address->shipping_address; ?>" name="shipping_address[]">
                                                 <span class="text-danger" id="shipping_address_err_<?php echo $key; ?>"></span>
                                              </div>
                                           </div>
                                           <?php if($key == 0){ ?>
                                           <div class="col-lg-1">
                                          ...
                                          <?php }else { ?>
                                            <div class="col-lg-1">
                                              <div class="pull-right">
                                                <div class="form-group m-form__group mt_25px">
                                                  <button type="button" class="btn btn-danger" onclick="address_rmv_row('<?php echo $key; ?>','<?php echo $shipping_address->lead_shipping_address_id; ?>');"><i class="fa fa-minus"></i></button>
                                                </div>
                                              </div>
                                           </div>
                                          <?php } ?>
                                      ...
                                      <input type="hidden" name="del_address_ids" id="del_address_ids">
                                      <input type="hidden" name="address_inc_count" id="address_inc_count" value="<?php if(count($shipping_addresses) > 0){ echo count($shipping_addresses); }else { echo '2'; } ?>">

                                      <div id="address1_block_append">
                                        <?php if(count($billing_addresses) > 0){ 

                                        foreach($billing_addresses as $key => $billing_address) {
                                        ?>
                                        <div class="row" id="address1_block_<?php echo $key; ?>">
                                          <input type="hidden" name="billing_address_id[]" value="<?php echo $billing_address->lead_billing_address_id; ?>">
                                           <div class="col-lg-11">
                                              <div class="form-group m-form__group">
                                                 <label>Billing Address</label>
                                                 <input type="text" class="form-control m-input m-input--square" placeholder="Enter Billing Address" id="billing_address_<?php echo $key; ?>" name="billing_address[]" value="<?php echo $billing_address->billing_address; ?>">
                                                 <span class="text-danger" id="billing_address_err_<?php echo $key; ?>"></span>
                                              </div>
                                           </div>
                                           <?php if($key == 0){ ?>
                                           <div class="col-lg-1">
                                         ...
                                         <?php }else { ?>
                                          <div class="col-lg-1">
                                              <div class="pull-right">
                                                <div class="form-group m-form__group mt_25px">
                                                  <button type="button" class="btn btn-danger" onclick="address1_rmv_row('<?php echo $key; ?>','<?php echo $billing_address->lead_billing_address_id; ?>');"><i class="fa fa-minus"></i></button>
                                                </div>
                                              </div>
                                           </div>
                                         <?php } ?>
                                      ...
                                      <input type="hidden" name="del_address1_ids" id="del_address1_ids">
                                      <input type="hidden" name="address1_inc_count" id="address1_inc_count" value="<?php if(count($billing_addresses) > 0){ echo count($billing_addresses); } else { echo '2'; } ?>">
...
{
  var exist_contact_no = '<?php echo $contact_book_info->contact_no; ?>';
  if (val != exist_contact_no) {
   $.ajax({
      type: "POST",
