<div class="modal-dialog lg" role="document">
  <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title" id="exampleModalLabel">Opportunity Import</h5>
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
               </button>
            </div>
             
            <form name="lead_import_form" id="lead_import_form" action="<?php echo base_url(); ?>Leads/oppo_bulk_import_update" method="POST" 
            ...
            <div class="modal-body">
                  <div class="row">
                      <div class="col-sm-12">
                          ...
                          <p class="text-muted text-justify" style="color:#434A54; text-indent:20px">
                            <i class="fa fa-star"></i> Sample file attached for your reference <a href="<?php echo base_url();?>Leads/oppo_upload_file" style="text-decoration:none"><i class="fas fa-cloud-download-alt" ></i></a> .
                          </p>
                   ...
                   <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group m-form__group">
                        <label for="exampleInputEmail1">Opportunity Upload</label>
                        <div></div>
