                        ...
                        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                           ...
                           <li class="m-nav__item">
                              ...
                              <a href="javascript:;" class="m-nav__link">
                                 ...
                                 <span class="m-nav__link-text">Opportunity Settings</span>
                           ...
                           <li class="m-nav__item">
                              ...
                              <a href="javascript:;" class="m-nav__link">
                                 ...
                                 <span class="m-nav__link-text">Opportunity Status List</span>
                        ...
                        <div class="m-portlet m-portlet--mobile ">
                           ...
                           <div class="m-portlet__body">
                              ...
                              <div class="alert alert-success alert-dismissible fade show" role="alert" id="active_success" style="display:none;">
                                 ...
                                 Opportunity Status has activated successfully.
                              ...
                              <div class="alert alert-danger alert-dismissible fade show" role="alert" id="inactive_success" style="display:none;">
                                 ...
                                 Opportunity Status has deactivated successfully.
...

                                    {
                                       ...
                                       { ?>
                                          ...
                                          <tr>
                                             ...
                                             <td><?php echo $l_status->oppo_status; ?></td>
                                             ...
                                             <td>
                                                ...
                                                <label>
                                                   ...
                                                   <input type="checkbox" <?php if($l_status->status==0){ echo "checked";} ?> name="activeunactive_<?php echo $i;?>" id="activeunactive_<?php echo $i;?>" onchange="activeunactive(<?php echo $l_status->oppo_status_id; ?>,<?php echo $i; ?>)" value="<?php echo $l_status->status;?>">
                                             ...
                                             <td>
                                                   ...
                                                   <a href="javascript:;" data-toggle="modal" data-target="#lead_status_edit" onclick="return lead_status_edit(<?php echo $l_status->oppo_status_id; ?>);"><span class="tooltip-animation" data-toggle="m-tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil-alt"></i></span></a>&nbsp;&nbsp;

                                              

                                                   <a href="javascript:;" data-toggle="modal" data-target="#delete_lead_status" onclick="return lead_status_delete(<?php echo $l_status->oppo_status_id; ?>);" ><span class="tooltip-animation" data-toggle="m-tooltip" data-placement="top" title="Delete"><i class="fa fa-trash-alt"></i></span></a>
...
<div class="container">
   ...
   <div class="modal fade" id="create_lead_status" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-dialog modal-md" role="document">
         ...
         <form name="create_lead_status" id="create_lead_status" method="POST" action="<?php echo base_url(); ?>Leads/oppo_status_add" onsubmit="return lead_status_validation()">

            <div class="modal-content">

               <div class="modal-header">

                  <h5 class="modal-title" id="exampleModalLabel">Create Opportunity Status</h5>
                        ...
                        <div class="row">
                           ...
                           <div class="col-lg-12">
                              ...
                              <div class="form-group m-form__group">
                                 ...
                                 <input type="text" class="form-control m-input m-input--square" placeholder="Enter Opportunity Status" name="lead_status" id="lead_status" maxlength="100" onblur="return lead_status_unique();">
...
<div class="container">
   ...
   <div class="modal fade" id="lead_status_edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-dialog modal-md" role="document">
         ...
         <form name="lead_status_edit_form" id="lead_status_edit_form" method="POST" action="<?php echo base_url(); ?>Leads/oppo_status_update" onsubmit="return lead_status_edit_validation()">

            <div class="modal-content">

               <div class="modal-header">

                  <h5 class="modal-title" id="exampleModalLabel">Edit Opportunity Status</h5>
                        ...
                        <div class="row">
                           ...
                           <div class="col-lg-12">
                              ...
                              <div class="form-group m-form__group">
                                 ...
                                 <input type="text" class="form-control m-input m-input--square" placeholder="Enter Opportunity Status" name="lead_status" 
...
<div class="container">
   ...
   <div class="modal fade" id="lead_status_delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-dialog" role="document">
         ...
         <form name="lead_status_delete_form" id="lead_status_delete_form" method="POST" action="<?php echo base_url(); ?>Leads/oppo_status_delete">

            <div class="modal-content">

               <div class="modal-header">

                  <h5 class="modal-title" id="exampleModalLabel">Delete Opportunity Status</h5>
               ...
               <div class="modal-body">
                  ...
                  <p>Are You Sure You Want to Drop this Opportunity Status permanently?</p>
...

{
...

   {
      ...
      $('#lead_status_err').html('Opportunity Status is required!');
...

{
...

   {
      ...
      $('#e_lead_status_err').html('Opportunity Status is required!');
...

{
   ...
   $.ajax({
      ...
      url:baseurl+'Leads/oppo_status_unique',
      ...
      success: function(result){
...

         {
            ...
            $('#lead_status_err').html('Opportunity Status already exists!');
...

{
   ...
   $.ajax({
      ...
      url:baseurl+'Leads/oppo_status_unique_edit',
      ...
      success: function(result){
...

         {
            ...
            $('#e_lead_status_err').html('Opportunity Status already exists!');
...

{
   ...
   $.ajax({
      ...
      url:baseurl+'Leads/oppo_status_edit',
...
function activeunactive(val,ival) {
   ...
   $.ajax({
      ...
      url:baseurl+'Leads/oppo_status_change_status',
      ...
      success: function(result){ 
        ...
        if(unactive == 0){
            ...
            window.location = baseurl+"Leads/oppo_status_list";
