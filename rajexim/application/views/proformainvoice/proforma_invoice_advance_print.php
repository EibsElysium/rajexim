...
@media print {
  ...
  #content:after {
    display: block;
    content: "";
    margin-bottom: 125mm; /* must be larger than largest paper size you support */
  }
}
</style>
  ...
  <div class="col-lg-12">
    <table border="1" style="border-collapse: collapse;width: 100%;">
      ...
      <tbody>
        ...
        <tr>
          <td colspan="2">
            <p style="margin:2px;"><b>Bank Details </b><br><u>Correspondence Bank</u></p>
            <p style="margin:2px;"><?php echo $bank_detail->correspondence_bank;?></p>  
          </td>
          <td colspan="2">
