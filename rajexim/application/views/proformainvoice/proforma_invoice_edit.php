                        ...
                        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                           ...
                           <li class="m-nav__item">
                              <a href="" class="m-nav__link">
                                 <span class="m-nav__link-text">Edit Proforma Invoice</span>
                              </a>
                           </li>
                        </ul>
                     </div>
                  ...
                  <div class="row">
                     <div class="col-xl-12">
                        ...
                        <div class="m-portlet">
                           ...
                           <!--end: Portlet Head-->
                                 <form class="m-form m-form--label-align-left- m-form--state-" id="m_form" method="POST" action="<?php echo base_url(); ?>proformainvoice/update_proformainvoice" onsubmit="return proformainvoice_validation();">
                                    <!--begin: Form Body -->
                                    <input type="hidden" id="proforma_invoice_id" name="proforma_invoice_id" value="<?php echo $proformainvoice_list->proforma_invoice_id;?>">
                                    <input type="hidden" id="is_local" name="is_local" value="<?php echo $proformainvoice_list->is_local;?>">
                                    <div class="m-portlet__body">
                                                ...
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <select class="form-control m-bootstrap-select m_selectpicker" data-live-search="true" id="exporter_id" name="exporter_id" onchange="getExporterDetail(this.value);"> 
                                                      ...
                                                      <?php foreach ($exporter_list as $vflist) {
                                                         if($vflist['status']==0){ ?>
                                                         <option value="<?php echo $vflist['exporter_id']; ?>" <?php echo $proformainvoice_list->exporter_id == $vflist['exporter_id']?'selected':'';?>><?php echo $vflist['exporter_name']; ?></option>
                                                      <?php }}?>
                                                   </select>
                                          ...
                                          <div class="row">
                                             ...
                                             <div class="col-lg-4">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <input type="text" id="proforma_invoice_date" name="proforma_invoice_date" class="form-control m_datepicker_1" value="<?php $qdate = explode('-', $proformainvoice_list->proforma_invoice_date); echo $qdate[1].'/'.$qdate[2].'/'.$qdate[0];?>">
                                             ...
                                             <div class="col-lg-4">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <input type="text" id="subject" name="subject" class="form-control"  placeholder="Enter Subject" value="<?php echo $proformainvoice_list->subject;?>">
                                          ...
                                          <div class="row">
                                                ...
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <select class="form-control custom-select" id="terms_of_payment_type_id" name="terms_of_payment_type_id" onchange="getTermsandPayment(this.value);"> 
                                                      ...
                                                      <?php foreach ($terms_of_payment_type_list as $vflist) {
                                                         if($vflist['status']==0){ ?>
                                                         <option value="<?php echo $vflist['terms_of_payment_type_id']; ?>" <?php echo $proformainvoice_list->terms_of_payment_type_id == $vflist['terms_of_payment_type_id']?'selected':'';?>><?php echo $vflist['terms_of_payment_type']; ?></option>
                                                      <?php }}?>
                                                   </select>
                                             ...
                                             <div class="col-lg-4">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <input type="text" id="buyer_confirmation_date" name="buyer_confirmation_date" class="form-control m_datepicker_1" value="<?php $qdate = explode('-', $proformainvoice_list->buyer_confirmation_date); echo $qdate[1].'/'.$qdate[2].'/'.$qdate[0];?>">
                                             ...
                                             <div class="col-lg-4">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <input type="text" id="other_reference" name="other_reference" class="form-control"  placeholder="Enter Other Reference" value="<?php echo $proformainvoice_list->other_reference;?>">
                                                ...
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <select class="form-control custom-select" id="pi_stage_id" name="pi_stage_id"> 
                                                      ...
                                                      <?php foreach ($pi_stage_list as $vflist) {
                                                         if($vflist['status']==0){ ?>
                                                         <option value="<?php echo $vflist['pi_stage_id']; ?>" <?php echo $proformainvoice_list->pi_stage_id == $vflist['pi_stage_id']?'selected':'';?>><?php echo $vflist['pi_stage']; ?></option>
                                                      <?php }}?>
                                                   </select>
                                          ...
                                          <div class="row">
                                                ...
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <!-- <select class="form-control m-bootstrap-select m_selectpicker" id="lead_id" name="lead_id" data-live-search="true" onchange="getLeadDetails(this.value);"> 
                                                      ...
                                                      <?php foreach ($opportunity_list as $vflist) { ?>
                                                         <option value="<?php echo $vflist['lead_id']; ?>" <?php echo $proformainvoice_list->lead_id == $vflist['lead_id']?'selected':'';?>><?php echo $vflist['lead_name']; ?></option>
                                                      <?php }?>
                                                   </select> -->
                                                   <input type="text" class="form-control" name="lead_id_by_name" id="lead_id_by_name" value="<?php $lead_info = common_select_values('*','leads','lead_id = "'.$proformainvoice_list->lead_id.'"','row'); $get_cb_info = common_select_values('*','contact_book','contact_book_id = "'.$lead_info->contact_book_id.'"','row'); echo $get_cb_info->lead_name; ?>" readonly>
                                                   <input type="hidden" name="lead_id" id="lead_id" value="<?php echo $proformainvoice_list->lead_id; ?>">
                                             ...
                                             <div class="col-lg-4">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <input type="text" id="organization_name" name="organization_name" class="form-control" value="<?php echo $proformainvoice_list->company_name;?>">
                                                </div>
                                             </div>
                                             <div class="col-lg-4">
                                                <div class="form-group m-form__group">
                                                   <label>Country<span class="text-danger">*</span></label>
                                                   <!-- <input type="text" name="" id="country" name="country" class="form-control"  readonly value="<?php //echo $proformainvoice_list->country_name;?>"> -->
                                                   <!-- <span class="text-danger"></span> -->
                                                   <select class="form-control m-bootstrap-select m_selectpicker" id="country" name="country" data-live-search="true"> 
                                                      ...
                                                      <?php foreach ($country_lists as $key => $c_list) { ?>
                                                         <option value="<?php echo $c_list->id; ?>" <?php echo $proformainvoice_list->country == $c_list->id?'selected':'';?>><?php echo $c_list->name; ?></option>
                                                      <?php }?>
                                                   </select>
                                          ...
                                          <div class="row">
                                             <div class="col-lg-4">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <input type="text" id="email_id" name="email_id" class="form-control" value="<?php echo $proformainvoice_list->email_id;?>">
                                             ...
                                             <div class="col-lg-4">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <input type="text" id="phone_no" name="phone_no" class="form-control" value="<?php echo $proformainvoice_list->contact_no;?>">
                                                </div>
                                             </div>
                                             <div class="col-lg-4">
                                                <div class="form-group m-form__group">
                                                   <label>Mobile No</label>
                                                   <input type="text" id="mobile_no" name="mobile_no" class="form-control" value="<?php echo $proformainvoice_list->office_phone_no;?>">
                                                </div>
                                             </div>
                                          </div>
                                          <div class="row">
                                             <div class="col-lg-4">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <input type="text" id="assigned_to" name="assigned_to" class="form-control"  readonly value="<?php echo $proformainvoice_list->lead_assigned_name;?>">
                                                </div>
                                             </div>
                                             <div class="col-lg-8">
                                                <div class="form-group m-form__group"> <label>Address</label>
                                                   <textarea class="snote" id="address" name="address"><?php echo $proformainvoice_list->address;?></textarea>
                                                </div>
                                             </div>
                                          </div>
                                          <div class="row">
                                                ...
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <select class="form-control m-bootstrap-select m_selectpicker" id="pre_carriage_by_id" name="pre_carriage_by_id" data-live-search="true"> 
                                                      ...
                                                      <?php foreach ($pre_carriage_by_list as $vflist) {
                                                         if($vflist['status']==0){ ?>
                                                         <option value="<?php echo $vflist['pre_carriage_by_id']; ?>" <?php echo $proformainvoice_list->pre_carriage_by_id == $vflist['pre_carriage_by_id']?'selected':'';?>><?php echo $vflist['pre_carriage_by']; ?></option>
                                                      <?php }}?>
                                                   </select>
                                             ...
                                             <div class="col-lg-4">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <input type="text" id="place_of_receipt_by_pre_carrier" name="place_of_receipt_by_pre_carrier" class="form-control"  placeholder="Enter Place of Receipt" value="<?php echo $proformainvoice_list->place_of_receipt_by_pre_carrier;?>">
                                                ...
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <select class="form-control m-bootstrap-select m_selectpicker" id="vessel_flight_id" name="vessel_flight_id" data-live-search="true" onchange="getFromPort(this.value);"> 
                                                      ...
                                                      <?php foreach ($vessel_flight_list as $vflist) {
                                                         if($vflist['status']==0){ ?>
                                                         <option value="<?php echo $vflist['vessel_flight_id']; ?>" <?php echo $proformainvoice_list->vessel_flight_id == $vflist['vessel_flight_id']?'selected':'';?>><?php echo $vflist['vessel_flight_name']; ?></option>
                                                      <?php }}?>
                                                   </select>
                                                ...
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <select class="form-control m-bootstrap-select m_selectpicker" id="port_of_discharge_id" name="port_of_discharge_id" data-live-search="true"> 
                                                      ...
                                                      <?php foreach ($port_list as $vflist) {
                                                         if($vflist['status']==0){ ?>
                                                         <option value="<?php echo $vflist['port_id']; ?>" <?php echo $proformainvoice_list->port_of_discharge_id == $vflist['port_id']?'selected':'';?>><?php echo $vflist['port_name']; ?> - <?php echo $vflist['port_city']; ?> - <?php echo $vflist['port_country']; ?></option>
                                                      <?php }}?>
                                                   </select>
                                             ...
                                             <div class="col-lg-4">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <select class="form-control m-bootstrap-select m_selectpicker" id="final_destination_id" name="final_destination_id" data-live-search="true"> 
                                                      ...
                                                      <?php foreach ($port_list as $vflist) {
                                                         if($vflist['status']==0){ ?>
                                                         <option value="<?php echo $vflist['port_id']; ?>" <?php echo $proformainvoice_list->final_destination_id == $vflist['port_id']?'selected':'';?>><?php echo $vflist['port_name']; ?> - <?php echo $vflist['port_city']; ?> - <?php echo $vflist['port_country']; ?></option>
                                                      <?php }}?>
                                                   </select>
                                       ...
                                       <fieldset>
                                          ...
                                          <div class="row">
                                                ...
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <select class="form-control m-bootstrap-select m_selectpicker" id="currency_id" name="currency_id" data-live-search="true" onchange="getCurrencyCode(this.value);"> 
                                                      ...
                                                      <?php foreach ($currency_list as $vflist) {
                                                         if($vflist['status']==0){ ?>
                                                         <option value="<?php echo $vflist['currency_id']; ?>" <?php echo $proformainvoice_list->currency_id == $vflist['currency_id']?'selected':'';?>><?php echo $vflist['currency_name']; ?> - <?php echo $vflist['currency_code']; ?></option>
                                                      <?php }}?>
                                                   </select>
                                             ...
                                             <div class="col-lg-4">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <input type="text" class="form-control" id="rate" name="ratec" placeholder="Enter Rate" value="<?php echo $proformainvoice_list->rate;?>">
                                          ...
                                          <div id="mcontent10">
                                             <?php $i=0; foreach($proformainvoice_product_list as $qplist){
                                             ...
                                             <fieldset id="mid<?php echo $i;?>">
                                                ...
                                                <?php //}?>
                                                   <div class="row">
                                                      ...
                                                      <div class="col-lg-2">
                                                         ...
                                                         <div class="col-lg-4" style="display: none;">
                                                            <div class="form-group m-form__group">
                                                               ...
                                                               <textarea class="form-control snote" id="specification<?php echo $i;?>" name="specification[]"><?php echo $qplist['product_item_spec'];?></textarea>
                                                      ...
                                                      <div class="col-lg-2" <?php echo $proformainvoice_list->is_local==0?"style=display:none;":'';?>>
                                                         <div class="form-group m-form__group">
                                          ...
                                          <?php if($proformainvoice_list->is_local==1){?>
                                             <fieldset>
                                                ...
                                                <div class="row">
                                                   <div class="col-lg-4">
                                                      <div class="form-group m-form__group">
                                                         ...
                                                         <input type="text" id="particulars" name="particulars" class="form-control" placeholder="Particulars" value="<?php echo $proformainvoice_other_charge_list->particulars;?>" onkeyup="getOthersAmount();">
                                                   ...
                                                   <div class="col-lg-2">
                                                      <div class="form-group m-form__group">
                                                         ...
                                                         <input type="text" id="taxable_amount" name="taxable_amount" class="form-control" placeholder="Enter Taxable Amount" value="<?php echo $proformainvoice_other_charge_list->taxable_amount;?>" onfocus="this.select();" onkeypress="return isNumberKey(event,this);" onkeyup="getOthersAmount();">
                                                ...
                                                <div class="col-lg-2">
                                                   <div class="form-group m-form__group">
                                                      ...
                                                      <select class="form-control m-bootstrap-select m_selectpicker" id="otax_type" name="otax_type" data-live-search="true" onchange="getOthersAmount();"> 
                                                         <option value='0' <?php echo $proformainvoice_other_charge_list->tax_type==0?'selected':'';?>>CGST/SGST</option>
                                                         <option value='1' <?php echo $proformainvoice_other_charge_list->tax_type==1?'selected':'';?>>IGST</option>
                                                      </select>
                                                ...
                                                <div class="col-lg-2">
                                                   <div class="form-group m-form__group">
                                                      <label>Tax %</label>
                                                      <input type="text" id="otax_percent" name="otax_percent" class="form-control" placeholder="Enter Tax %" value="<?php echo $proformainvoice_other_charge_list->tax_percent;?>" onfocus="this.select();" onkeypress="return isNumberKey(event,this);" onkeyup="getOthersAmount();">
                                                   ...
                                                   <div class="col-lg-2">
                                                      <div class="form-group m-form__group">
                                                         <label>Amount</label>
                                                         <input type="text" id="oamount" name="oamount" class="form-control" readonly value="<?php echo $proformainvoice_other_charge_list->amount;?>">
                                          ...
                                          <div class="row mt_25px">
                                             ...
                                             <div class="col-lg-3">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <input type="text" id="grand_total" name="grand_total" class="form-control" readonly value="<?php echo $proformainvoice_list->grand_total;?>">
                                                </div>
                                             </div>
                                          </div>
                                       ...
                                       <fieldset>
                                          ...
                                          <div class="row">
                                             <div class="col-lg-6" id="snote1">
                                                <div class="form-group m-form__group">
                                                   <label>Sales Note</label><i class="fa fa-power-off show_snote"></i>
                                                   <textarea class="form-control snote" id="sales_note" name="sales_note"><?php echo $proformainvoice_list->sales_note;?></textarea>
                                                   <span class="text-danger" id="sales_note_err"></span>
                                                </div>
                                             </div>
                                             <div class="col-lg-6" id="snote2">
                                                <div class="form-group m-form__group">
                                                   <label>Purchase Note</label><i class="fa fa-power-off show_snote2"></i>
                                                   <textarea class="form-control snote" id="purchase_note" name="purchase_note"><?php echo $proformainvoice_list->purchase_note;?></textarea>
                                                   <span class="text-danger" id="purchase_note_err"></span>
                                                </div>
                                             </div>                                              
                                          </div>
                                          <div class="row">
                                             <div class="col-lg-6" id="snote3">
                                                <div class="form-group m-form__group">
                                                   <label>Shipping Note</label><i class="fa fa-power-off show_snote3"></i>
                                                   <textarea class="form-control snote" id="shipping_note" name="shipping_note"><?php echo $proformainvoice_list->shipping_note;?></textarea>
                                                   <span class="text-danger" id="shipping_note_err"></span>
                                                </div>
                                             </div>
                                             <div class="col-lg-6" id="snote4">
                                                <div class="form-group m-form__group">
                                                   <label>Accounts Note</label><i class="fa fa-power-off show_snote4"></i>
                                                   <textarea class="form-control snote" id="accounts_note" name="accounts_note"><?php echo $proformainvoice_list->accounts_note;?></textarea>
                                          ...
                                          <div class="row" style="display:none;">
                                             <div class="col-lg-6">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <textarea class="form-control snote" id="specification_packing_details" name="specification_packing_details"><?php echo $proformainvoice_list->specification_packing_details;?></textarea>
                                       ...
                                       <fieldset>
                                          ...
                                          <div class="row">
                                             <div class="col-lg-6">
                                                <div class="form-group">
                                                   ...
                                                   <input type="text" id="price_validity" name="price_validity" class="form-control"  placeholder="Enter Price Validity" value="<?php echo $proformainvoice_list->price_validity;?>">
                                                   <span class="text-danger" id="price_validity_err"></span>
                                                </div>
                                                <div class="form-group">
                                                   <label>Loadability<span class="text-danger">*</span></label>
                                                   <textarea class="form-control snote" id="loadability" name="loadability"><?php echo $proformainvoice_list->loadability;?></textarea>
                                                   <span class="text-danger" id="loadability_err"></span>
                                                </div>
                                             </div>
                                             <div class="col-lg-6">
                                                <label>Specificaiton Groups</label>
                                                <textarea class="form-control snote" id="specification_group" name="specification_group"><?php echo $proformainvoice_list->specification_group; ?></textarea>
                                             </div>
                                                ...
                                                <div class="form-group">
                                                   ...
                                                   <select class="form-control m-bootstrap-select m_selectpicker" id="interest_id" name="interest_id" data-live-search="true" onchange="getInterestText(this.value);"> 
                                                      ...
                                                      <?php foreach ($interest_list as $vflist) {
                                                         if($vflist['status']==0){ ?>
                                                         <option value="<?php echo $vflist['interest_id']; ?>" <?php echo $proformainvoice_list->interest_id == $vflist['interest_id']?'selected':'';?>><?php echo $vflist['interest_label']; ?></option>
                                                      <?php }}?>
                                                   </select>
                                                   <span class="text-danger" id="interest_id_err"></span>
                                                </div>                                               
                                                <div class="form-grou inttext" style="<?php echo $proformainvoice_list->interest_id!=0?'':'display:none';?>">
                                                   <textarea class="form-control snote " id="intrest_text" name="intrest_text" readonly ><?php echo $interest_text;?></textarea>
                                                </div>
                                             </div> 
                                             <div class="col-lg-6">                                                
                                                <div class="form-group">
                                                ...
                                                <div class="form-group taptext" style="<?php echo $proformainvoice_list->terms_and_payment!=''?'':'display:none';?>">
                                                   <textarea class="form-control  snote" id="terms_and_payment_text" name="terms_and_payment_text" ><?php echo $proformainvoice_list->terms_and_payment; ?></textarea>
                                                </div>
                                             </div> 
                                          ...
                                          <div class="row">
                                             <div class="col-lg-6">                                                
                                                ...
                                                <div class="form-group toptext">
                                                   <textarea class="form-control  snote" id="terms_of_payment_text" name="terms_of_payment_text" ><?php echo $proformainvoice_list->terms_of_payment; ?></textarea>
                                                </div>
                                             </div>  
                                             <div class="col-lg-6">                                                
                                                <div class="form-group">
                                                   ...
                                                   <select class="form-control m-bootstrap-select m_selectpicker" id="arbitration_id" name="arbitration_id" data-live-search="true" onchange="getArbitrationText(this.value);"> 
                                                      ...
                                                      <?php foreach ($arbitration_list as $vflist) {
                                                         if($vflist['status']==0){ ?>
                                                         <option value="<?php echo $vflist['arbitration_id']; ?>" <?php echo $proformainvoice_list->arbitration_id == $vflist['arbitration_id']?'selected':'';?>><?php echo $vflist['arbitration_label']; ?></option>
                                                      <?php }}?>
                                                   </select>
                                                   <span class="text-danger" id="arbitration_id_err"></span>
                                                </div>                                               
                                                <div class="form-group arbtext" style="<?php echo $proformainvoice_list->arbitration_id!=0?'':'display:none';?>;">
                                                   <textarea class="form-control snote " id="arbitration_text" name="arbitration_text" readonly ><?php echo $arbitration_text;?></textarea>
                                                </div>
                                             </div> 
                                                ...
                                                <div class="form-group">
                                                   ...
                                                   <select class="form-control m-bootstrap-select m_selectpicker" id="declaration_id" name="declaration_id" data-live-search="true" onchange="getDeclarationText(this.value);"> 
                                                      ...
                                                      <?php foreach ($declaration_list as $vflist) {
                                                         if($vflist['status']==0){ ?>
                                                         <option value="<?php echo $vflist['declaration_id']; ?>" <?php echo $proformainvoice_list->declaration_id == $vflist['declaration_id']?'selected':'';?>><?php echo $vflist['declaration_label']; ?></option>
                                                      <?php }}?>
                                                   </select>
                                                   <span class="text-danger" id="declaration_id_err"></span>
                                                </div>                                               
                                                <div class="form-group dectext" style="<?php echo $proformainvoice_list->arbitration_id!=0?'':'display:none';?>;">
                                                   <textarea class="form-control snote " id="declaration" name="declaration" readonly  ><?php echo $declaration;?></textarea>
                                                </div>
                                             </div>  
                                             <div class="col-lg-6">
                                                <div class="form-group dectext">
                                                   <label>Price<span class="text-danger">*</span></label>
                                                   <textarea class="form-control snote " id="price" name="price" ><?php echo $proformainvoice_list->price;?></textarea>
                                             ...
                                             <div class="col-lg-12">
                                                <div class="form-group">
                                                   <label>Document Required<span class="text-danger">*</span></label>
                                                      <div class="row"> 
                                                   <?php $arr = explode(',', $proformainvoice_list->document_required); $i=0; $cdlist = count($document_required_list);foreach($document_required_list as $docreq){
                                                      if($docreq['status']==0){?>                                 
                                                         <div class="col-lg-4">
                                                            <div class="form-group m-form__group">
                                                               <label class="m-checkbox m-checkbox--bold m-checkbox--state-success mt_25px">
                                                                  <input type="checkbox" <?php echo in_array($docreq['document_required_id'], $arr)?'checked':'';?> class="menu_checkbox" id="document_required<?php echo $i;?>" name="document_required" value="<?php echo $docreq['document_required_id'];?>" onchange="changeDocReq();"> <?php echo $docreq['document_required'];?>
                                                                  <span></span>
                                                               </label>
                                                            </div>
                                                         </div>                                                         
                                                   <?php }$i++;}?>
                                                      ...
                                                      <input type="hidden" id="docrequired" name="docrequired" value="<?php echo $proformainvoice_list->document_required;?>">
                                                </div>
                                             </div>
                                          </div>
...
$("#snote3 i.show_snote3").click(function(){
   $('#snote3 .note-toolbar-wrapper').toggle();
   $('#snote3 .note-editable').toggleClass("mt");
  });

$("#snote4 i.show_snote4").click(function(){
   $('#snote4 .note-toolbar-wrapper').toggle();
   $('#snote4 .note-editable').toggleClass("mt");
  });
