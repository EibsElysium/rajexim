                     ...
                     <div class="col-xl-12">
                        <div class="m-portlet m-portlet--mobile ">
                           <div class="m-portlet__head">
                              ...
                              <div class="m-portlet__head-tools">
                                 <ul class="m-portlet__nav">
                                    ...
                                    <li class="m-portlet__nav-item">
                                       <a href="<?php echo base_url(); ?>multiproductcostingproduct/multi_product_costing_product_add" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air">
                                          <span>
                                             <i class="la la-plus"></i>
                                             <span>Create Multi Product Costing - P</span>
                                          </span>
                                       </a>
                                    </li>
                                    <?php }?>
                           ...
                           <div class="m-portlet__body">
                              ...
                              <form method="POST" action="<?php echo base_url();?>multiproductcostingproduct">
...
<script type="text/javascript">
   ...
   var title = $('title').text() + ' | ' + 'Multi Product Costing - P List';
...
function submit_product_costing_form(diff) {
   ...
   $.ajax({
      url:baseurl+'multiproductcostingproduct/multi_product_costing_product_result_list',
      type:'POST',
