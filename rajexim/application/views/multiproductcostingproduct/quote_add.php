                                 ...
                                 <form class="m-form m-form--label-align-left- m-form--state-" id="m_form" method="POST" action="<?php echo base_url(); ?>quote/create_quote" onsubmit="return quote_validation();">
                                    ...
                                    <div class="m-portlet__body">
                                          ...
                                          <div class="row">
                                             <div class="col-lg-4">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <input type="hidden" id="lead_id" name="lead_id" value="<?php echo $lead_list->lead_id;?>">
                                       ...
                                       <fieldset>
                                          ...
                                          <div class="row">
                                                ...
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <select class="form-control m-bootstrap-select m_selectpicker" id="currency_id" name="currency_id" data-live-search="true" onchange="getCurrencyCode(this.value);"> 
                                                      ...
                                                      <?php foreach ($currency_list as $vflist) {
                                                         if($vflist['status']==0){ ?>
                                                         <option value="<?php echo $vflist['currency_id']; ?>" <?php echo $vflist['currency_id']==$curid?'selected':'';?>><?php echo $vflist['currency_name']; ?> - <?php echo $vflist['currency_code']; ?></option>
                                                      <?php }}?>
                                                   </select>
                                             ...
                                             <div class="col-lg-3">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <input type="text" class="form-control" id="rate" name="ratec" placeholder="Enter Rate" value="<?php echo $convrate;?>">
                                          ...
                                          <div id="mcontent10">
                                             <?php $tamt = 0;$i=0;foreach($multi_product_costing_product_input_list as $mpcpinput){
                                                $totalamt = $mpcpinput['quantity']*round($mpcpinput['cnf_price'],2);
                                                $prodstage = $this->Productcosting_model->get_product_costing_stage_by_id($mpcpinput['product_costing_stage_id']);
                                                $dispname = $this->Productcosting_model->get_display_name_by_product_item_display_name_id($mpcpinput['product_item_display_name_id']);
                                                ?>
                                                      ...
                                                      <div class="row">
                                                         ...
                                                         <div class="col-lg-2">
                                                            <div class="form-group m-form__group">
                                                               ...
                                                               <input type="text" id="marks_and_no<?php echo $i;?>" name="marks_and_no[]" class="form-control" placeholder="Enter Mark & No">
                                                         ...
                                                         <div class="col-lg-2">
                                                            <div class="form-group m-form__group">
                                                               ...
                                                               <input type="text" class="form-control" id="pname<?php echo $i;?>" name="pname[]" value="<?php echo $mpcpinput['product_name'].' - '.$mpcpinput['product_item'];?>" readonly>
                                                               <input type="hidden" id="product_item_id<?php echo $i;?>" name="product_item_id[]" value="<?php echo $mpcpinput['product_item_id'];?>">
                                                         ...
                                                         <div class="col-lg-2">
                                                            <div class="form-group m-form__group">
                                                              ...
                                                              <!--  <input type="text" id="specification<?php //echo $i;?>" name="specification[]" class="form-control snote" placeholder="Specification" value="<?php //echo $mpcpinput['product_item_spec'];?>" readonly> -->

                                                               <textarea class="form-control snote" id="specification<?php echo $i;?>" name="specification[]" rows="3"><?php echo $mpcpinput['product_item_spec'];?></textarea>
                                                            ...
                                                            <div class="form-group m-form__group">
                                                               ...
                                                               <select class="form-control m-bootstrap-select m_selectpicker" id="sku_unit_id<?php echo $i;?>" name="sku_unit_id[]" data-live-search="true"> 
                                                                  ...
                                                                  <?php foreach($product_unit as $punit){?>
                                                                     <option value="<?php echo $punit['product_unit_id'];?>" <?php echo $punit['product_unit_id'] == $prodstage->stage_name?'selected':'';?>><?php echo $punit['product_unit'];?></option>
                                                                  <?php }?>
                                                               </select>
                                                         ...
                                                         <div class="col-lg-2">
                                                            <div class="form-group m-form__group">
                                                               ...
                                                               <input type="text" id="quantity<?php echo $i;?>" name="quantity[]" class="form-control" placeholder="Enter Quantity" value="<?php echo $mpcpinput['quantity'];?>" onfocus="this.select();" onkeypress="return isNumberKey(event,this);" onkeyup="getAmount(<?php echo $i;?>);" readonly>
                                                         ...
                                                         <div class="col-lg-2">
                                                            <div class="form-group m-form__group">
                                                               ...
                                                               <input type="text" id="rate<?php echo $i;?>" name="rate[]" class="form-control" placeholder="Enter Rate" value="<?php echo round($mpcpinput['cnf_price'],2);?>" onfocus="this.select();" onkeypress="return isNumberKey(event,this);" onkeyup="getAmount(<?php echo $i;?>);" readonly>
                                                         ...
                                                         <div class="col-lg-2" <?php echo $quote_type==0?"style=display:none;":'';?>>
                                                            <div class="form-group m-form__group">
                                                               ...
                                                               <input type="text" id="tax_percent<?php echo $i;?>" name="tax_percent[]" class="form-control" placeholder="Enter Tax %" value="0" onfocus="this.select();" onkeypress="return isNumberKey(event,this);" onkeyup="getAmount(<?php echo $i;?>);">
                                                         ...
                                                         <div class="col-lg-2">
                                                            <div class="form-group m-form__group">
                                                               ...
                                                               <input type="text" id="amount<?php echo $i;?>" name="amount[]" class="form-control" readonly value="<?php echo $totalamt;?>">
                                          ...
                                          <div class="row mt_25px">
                                             ...
                                             <div class="col-lg-3">
                                                <div class="form-group m-form__group">
                                                   ...
                                                   <input type="text" id="grand_total" name="grand_total" class="form-control" readonly value="<?php echo $tamt;?>">
                                                </div>
                                             </div>
                                          </div>
