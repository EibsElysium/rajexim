                              ...
                              <div class="row"> 
                                 <div class="col-lg-12">  
                                    <table class="table table-striped- table-bordered table-checkable" id="">
                                       ...
                                       <tbody>
                                          <?php if(count($multi_product_costing_product_lists_count)>0){$i=0;foreach ($multi_product_costing_product_list as $qlist){
...
<div class="row">
 <div class="col-lg-12" >
   <div class="col-lg-2">Showing <?php echo $page + 1; ?> to <?php echo (($page + $perpage) > count($multi_product_costing_product_lists_count)) ? count($multi_product_costing_product_lists_count) : $page + $perpage; ?> of <?php echo count($multi_product_costing_product_lists_count); ?> entries</div>
   <div class="col-lg-7"></div>
   <div class="col-lg-3">
    <?php if (count($multi_product_costing_product_lists_count) > $perpage) { ?>
    <ul class="pagination">
      ...
      <?php 
        $last_page_count = '';
        $split_list = (int) (count($multi_product_costing_product_lists_count) / $perpage);
        $remaining_val = count($multi_product_costing_product_lists_count) % $perpage;
        if ($remaining_val == 0) {
      ...
      <?php }  ?>
      <?php if (($page + $perpage) < count($multi_product_costing_product_lists_count)){ ?>
