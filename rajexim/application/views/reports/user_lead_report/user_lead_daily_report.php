<div class="row">
   <div class="col-lg-12">
      ...
      <table class="table table-striped- table-bordered table-checkable m-table m-table--head-bg-theme usage_cost" width="100%">
         <thead>
            <tr>
               ...
               <th data-orderable="false">Assigned Product</th>
               <?php
         ...
         <tbody>
            <?php
               ...
               if(!empty($user_name_with_assigned_product))
               {
                $ind_col = 0;
                $inter_col = 0;
                // foreach ($user_name_with_assigned_product as $key => $user_product) {
                //   $unique_user_id = array_unique((array)$user_product->user_id);
                //   print_r($unique_user_id);
                // }
                    ...
                    <tr>
                     ...
                     <?php
                        ...
                        { 
                           ...
                           $check_date = $f_year_month.'-'.$d_format;
                           $get_day_lead_by_user_product = get_day_lead_by_user_product($user_product->product_id,$user_product->user_id,$check_date);
                           $get_day_lead_by_user_product_from_india = get_day_lead_by_user_product_from_india($user_product->product_id,$user_product->user_id,$check_date);
                           ?>
      ...
      <table id="daily_lead_user_report_export" style="display: none;">
         <thead>
            <tr>
               <th>User </th>
