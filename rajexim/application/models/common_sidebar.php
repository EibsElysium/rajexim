...
<div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark " m-menu-vertical="1" m-menu-scrollable="1" m-menu-dropdown-timeout="500">
                  <ul class="m-menu__nav ">
                    <?php if($_SESSION['DashboardView']==1){ ?>
                    ...
                    <?php if($_SESSION['Lead ManagementView']==1){ ?>
                      <li class="m-menu__item" aria-haspopup="true"><a href="<?php echo base_url(); ?>Leads" class="m-menu__link "><span class="m-menu__item-here"></span><i class="m-menu__link-icon la la-filter"></i><span class="m-menu__link-text">Lead Management</span></a>
                      </li>
                    <?php } ?>
                    <?php if($_SESSION['Lead ManagementView']==1){ ?>
                    ...
                    <?php } ?>
                     <?php if($_SESSION['Product CostingView']==1 || $_SESSION['Multi Product CostingView']==1 || $_SESSION['Multi Product Costing - PView']==1){ ?>
                    <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover">
                           <a href="javascript:;" class="m-menu__link m-menu__toggle"><span class="m-menu__item-here"></span><i class="m-menu__link-icon la la-money"></i><span
                              class="m-menu__link-text">Product Costing</span><i class="m-menu__ver-arrow la la-angle-right"></i></a>
                              ...
                              <ul class="m-menu__subnav">
                                <?php if($_SESSION['Product CostingView']==1){ ?>
                                 <li class="m-menu__item" aria-haspopup="true">    <a href="<?php echo base_url(); ?>productcosting" class="m-menu__link ">
                                       <i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Single Costing</span>
                                    </a>
                                 </li>
                                 <?php }?>
                                <?php if($_SESSION['Multi Product CostingView']==1){ ?>
                                 <li class="m-menu__item" aria-haspopup="true">    <a href="<?php echo base_url(); ?>multiproductcosting" class="m-menu__link ">
                                       <i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Multi Costing - G</span>
                                    </a>
                                 </li>
                                 <?php }?>
                                <?php if($_SESSION['Multi Product Costing - PView']==1){ ?>
                                 <li class="m-menu__item" aria-haspopup="true">    <a href="<?php echo base_url(); ?>multiproductcostingproduct" class="m-menu__link ">
                                       <i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Multi Costing - P</span>
                                    </a>
                                 </li>
                                 <?php }?>
                               </ul>
                              ...
                              <ul class="m-menu__subnav">
                                <?php if($_SESSION['General SettingsEdit']==1){ ?>
                                 <li class="m-menu__item" aria-haspopup="true">    <a href="<?php echo base_url(); ?>Settings" class="m-menu__link ">
                                       <i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">General Settings</span>
                                    </a>
                                 </li>
                                 <?php }?>
                                 <?php if($_SESSION['Dashboard SettingsEdit']==1){ ?>
                                    <li class="m-menu__item " aria-haspopup="true">
                                      <a href="<?php echo base_url(); ?>dashboardsettings" class="m-menu__link ">
                                       <i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Dashboard Settings</span>
                                      </a>
                                    </li>
                                  <?php }?>
                                 ...
                                 <?php if($_SESSION['Loading TypeView']==1){ ?>
                                    <li class="m-menu__item " aria-haspopup="true">
                                      <a href="<?php echo base_url(); ?>loadingtype" class="m-menu__link ">
                                       <i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Loading Type</span>
                                      </a>
                                    </li>
                                  <?php }?>
                                 <?php if($_SESSION['DesignationView']==1){ ?>
                                    <li class="m-menu__item " aria-haspopup="true">
                                      <a href="<?php echo base_url(); ?>designation" class="m-menu__link ">
                                       <i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Designation</span>
                                      </a>
                                    </li>
                                  <?php }?>
                                 <?php if($_SESSION['ContainerView']==1){ ?>
                                    <li class="m-menu__item " aria-haspopup="true">
                                      <a href="<?php echo base_url(); ?>container" class="m-menu__link ">
                                       <i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Container</span>
                                      </a>
                                    </li>
                                  <?php }?>
                                <li class="m-menu__item " aria-haspopup="true">  <a href="<?php echo base_url(); ?>Settings/display_menu" class="m-menu__link ">
                                       <i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Menu Display Settings</span>
                                    </a>
                                 </li>
                                 ...
                                 <?php } ?>
                                <?php if($_SESSION['ExporterView']==1 || $_SESSION['Quote StageView']==1 || $_SESSION['Vessel FlightView']==1 || $_SESSION['PortView']==1 || $_SESSION['Price TermsView']==1 || $_SESSION['CurrencyView']==1 || $_SESSION['InterestView']==1 || $_SESSION['PI StageView']==1 || $_SESSION['Pre-Carriage ByView']==1 || $_SESSION['Terms of PaymentView']==1 || $_SESSION['Terms and PaymentView']==1 || $_SESSION['ArbitrationView']==1 || $_SESSION['DeclarationView']==1 || $_SESSION['Document RequiredView']==1 || $_SESSION['Bank DetailView']==1 || $_SESSION['Product Costing CategoryView']==1 || $_SESSION['Product Costing TypeView']==1 || $_SESSION['Multi Product Costing TypeView']==1 || $_SESSION['Multi Product Costing Type - PView']==1){ ?>
                                 <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover">
                                    <a href="javascript:;" class="m-menu__link m-menu__toggle">
                                    <i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i>
                                    <span
                                    ...
                                    <div class="m-menu__submenu ">
                                       ...
                                       <ul class="m-menu__subnav">
                                        ...
                                        <?php if($_SESSION['Multi Product Costing TypeView']==1){ ?>
                                          <li class="m-menu__item " aria-haspopup="true"><a href="<?php echo base_url(); ?>multiproductcostingtype" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Multi Product Costing Type - G</span></a>
                                          </li>
                                          <?php }?>
                                ...
                                <?php if($_SESSION['Vendor TypeView']==1 || $_SESSION['Vendor CategoryView']==1 || $_SESSION['VendorView']==1){ ?>
                                 <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover">
                                    <a href="javascript:;" class="m-menu__link m-menu__toggle">
                                    <i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i>
                                    <span
                                    ...
                                    <div class="m-menu__submenu ">
                                       ...
                                       <ul class="m-menu__subnav">
                                        ...
                                        <?php if($_SESSION['VendorView']==1){ ?>
                                          <li class="m-menu__item " aria-haspopup="true"><a href="<?php echo base_url(); ?>vendor" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Vendor List</span></a>
                                          </li>
                                          <?php }?>
                                       </ul>
                                    </div>
