...
class Currency_model extends CI_Model 
{
  ...
  {
    $result = $this->db->query("CALL create_currency('".$data['currency_name']."','".$data['currency_code']."','".$data['currency_symb']."','".$data['created_on']."','".$data['created_by']."','".$data['currency_int']."','".$data['currency_dec']."')");
    save_query_in_log();
    return $result;
  }
  ...
  {
    $result = $this->db->query("CALL update_currency('".$data['currency_id']."', '".$data['currency_name']."','".$data['currency_code']."','".$data['currency_symb']."','".$data['modi_on']."','".$data['modi_by']."','".$data['currency_int']."','".$data['currency_dec']."')");
    save_query_in_log();
    return $result;
  }
